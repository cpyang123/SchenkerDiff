...
def get_resume(cfg, model_kwargs):
    ...
    cfg = src.utils.update_config_with_new_keys(cfg, saved_cfg)
    return cfg, model
...
def get_resume_adaptive(cfg, model_kwargs):
    ...
    new_cfg = src.utils.update_config_with_new_keys(new_cfg, saved_cfg)
    return new_cfg, model



@hydra.main(version_base='1.3', config_path='../DiGress/configs', config_name='config')
def main(cfg: DictConfig):
    ...
    if cfg.train.ema_decay > 0:
        ema_callback = src.utils.EMA(decay=cfg.train.ema_decay)
