...
class DummyExtraFeatures:
    ...
    def __call__(self, noisy_data):
        ...
        return src.utils.PlaceHolder(X=empty_x, E=empty_e, y=empty_y)
...
class ExtraFeatures:
    ...
    def __call__(self, noisy_data):
        ...
        if self.features_type == 'cycles':
            ...
            return src.utils.PlaceHolder(X=x_cycles, E=extra_edge_attr, y=torch.hstack((n, y_cycles, n_components,
                                                                                    batched_eigenvalues)))
            ...
            return src.utils.PlaceHolder(X=torch.cat((x_cycles, nonlcc_indicator, k_lowest_eigvec), dim=-1),
                                     E=extra_edge_attr,
