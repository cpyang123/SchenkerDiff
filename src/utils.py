    ...
    def mask(self, node_mask, collapse=False):
        ...
        if collapse:
            ...
            try:
                ...
                print("Tensor E:")
                print(self.E)
                print("Transposed Tensor E:")
                print(torch.transpose(self.E, 1, 2))
                print("Differnece")
                print(self.E - torch.transpose(self.E, 1, 2))
                raise  # Re-raise the exception after printing the tensors
        return self
